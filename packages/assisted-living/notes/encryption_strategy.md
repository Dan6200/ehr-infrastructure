...
3.  **Medical Info:** `allergies`, `prescriptions`, `diagnostic_history` (High sensitivity)
...
4.  **Store Everything:** Your Firestore document would now store the encrypted data fields alongside all the _encrypted_ DEKs.
